            ...
            >
              ...
              <div className="pl-3 w-full">
                <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                  ...
                  : "Attached is the material outline for course project"
                </div>
            ...
            >
              ...
              <div className="pl-3 w-full">
                <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                  ...
                  {' '}viewed your course project submission.
                </div>
                <div className="text-xs font-medium text-primary-700 dark:text-primary-400">
                  44 miin
                </div>
            ...
            >
              ...
              <div className="pl-3 w-full">
                <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                  ...
                  {' '}relay concerns to my working email for assistance
                </div>
                <div className="text-xs font-medium text-primary-700 dark:text-primary-400">
                  1 hr
                </div>
            ...
            >
              ...
              <div className="pl-3 w-full">
                <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                  ...
                  {' '}posted a new video: SQA - learn how to implement quality measures.
                </div>
                <div className="text-xs font-medium text-primary-700 dark:text-primary-400">
                  3 hr
                </div>
  ...
  <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
    ...
    <div className="mt-4 md:mt-0">
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
        Check your course project progress
      </h2>
      <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
        see how far you are from completing your course project and interact with others. See remarks also from your lecturer and speak with your TA for assistance
      </p>
      <a
